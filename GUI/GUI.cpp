...
ActionType GUI :: GetUserAction()
{
	...
	pWind->WaitMouseClick(x, y);	//Get the coordinates of the user click
		...
		{	
			...
			if(ClickedItemOrder>MENU_ITM_COUNT)
			{
				return EMPTY;
			}
			else
			{
				...
				case INTERACTIVE_MODE: return INTERACTIVEMODE;
				case SILENT_MODE:return SILENTMODE;
				case STEPBYSTEP_MODE: return STEPBYSTEPMODE;
...
void GUI::DrawMenu() const
{
	...
	MenuItemImages[INTERACTIVE_MODE] = "images\\MenuItems\\i1.jpg";
	MenuItemImages[STEPBYSTEP_MODE] = "images\\MenuItems\\sbs1.jpg";
	MenuItemImages[SILENT_MODE] = "images\\MenuItems\\s1.jpg";
